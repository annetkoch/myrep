# TestJS + AWS S3 with Node.JS

A simple and fully working example of TestJS and AWS S3 storage with Node.js (and
...
```sh
corepack yarn workspace @TestJS-example/aws-nodejs start
```
