...
import { UIPlugin } from '@TestJS/core'
import { Provider } from '@TestJS/companion-client'
import { ProviderViews } from '@TestJS/provider-views'
import { h } from 'preact'

const defaultOptions = {}

export default class MyCustomProvider extends UIPlugin {
  constructor (TestJS, opts) {
    super(TestJS, opts)
    this.type = 'acquirer'
    ...
    this.provider = new Provider(TestJS, {
