...
// instead of the npm version—in a real app use `require('@TestJS/companion')`
const bodyParser = require('body-parser')
const session = require('express-session')
const TestJS = require('@TestJS/companion')
...
app.get('/', (req, res) => {
  ...
  res.send('Welcome to my TestJS companion service')
})
...
app.use(TestJS.app(TestJSOptions).app)
...
TestJS.socket(app.listen(3020), TestJSOptions)
