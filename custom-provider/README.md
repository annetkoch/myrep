# TestJS + Companion + Custom Provider Example

This example uses @TestJS/companion with a dummy custom provider.
...
corepack yarn build
corepack yarn workspace @TestJS-example/custom-provider start
```
